...
const navItems = (agencyId: string): Array<{ href: string; icon: React.ElementType; label: string; route: AppRouteKey }> => [
  ...
  { href: `/app/${agencyId}/analytics`, icon: BarChart3, label: 'Analytics', route: 'analytics' },
  { href: `/app/${agencyId}/sub-agents`, icon: Building2, label: 'Sub-Agents', route: 'sub-agents' },
  { href: `/app/${agencyId}/commissions`, icon: HandCoins, label: 'Commissions', route: 'commissions' },
  ...
  { href: `/app/${agencyId}/payroll`, icon: Banknote, label: 'Payroll', route: 'payroll' },
